...
// Single Ad Page START
	...
	// edit the videos
	if(hash == "videos") { edit_ad_images(); }
	$('.item-page .edit-ad-menu .edit-ad-buttons .edit-videos').on('click', function(event) {
		edit_ad_videos();
	});
	function edit_ad_videos() {
		$('.item-page .edit-ad-menu .edit-ad-buttons .active').removeClass('active');

		if($('.item-page .edit-entry').is(':visible') && $('.edit-entry .post-form section.videos').is(':visible')) {
			// close edit ad section
			$('.item-page .page-section').hide();
			$('.item-page .entry').fadeIn('250');
		} else {
			$('.item-page .page-section').hide();
			$('.item-page .edit-entry').fadeIn('250');
			$('.item-page .edit-ad-menu .edit-ad-buttons .edit-videos').addClass('active');
		}

		$('.edit-entry .post-form section.images').hide();
		$('.edit-entry .post-form section.videos').show();
		$('.edit-entry .post-form section.fields, .edit-entry .post-form .submit-form').hide();
	}
